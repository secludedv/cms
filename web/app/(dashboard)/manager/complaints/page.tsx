...
export default function ManagerComplaintsPage() {
  const { data: complaints, isLoading } = useComplaints("/manager");
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Complaints"
        description="Complaints from your customers"
        action={
          <Button asChild>
            <Link href="/manager/complaints/new">
